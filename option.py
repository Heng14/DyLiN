...
parser.add_argument('--hyperdata', action='store_true')

parser.add_argument("--render_only_fix_pose", action='store_true', 
                    help='do not optimize, reload weights and render out render_poses path with fixed pose changing t')
